...
trans = read.transactions("PAbusiness_top_rated_clustered.csv", format = "basket", sep = ",", rm.duplicates=TRUE, cols = 1)
str(trans)
rules=apriori(trans, parameter = list(supp=0.005, conf=0.75))
inspect(rules)
